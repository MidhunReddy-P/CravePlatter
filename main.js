...
function goToSignin(e, openInNewTab = false) {
  if (e) e.preventDefault();
  if (openInNewTab) window.open('signin.html', '_blank');
  else window.location.href = 'signin.html';
}

if (signinBtn) {
  signinBtn.addEventListener('click', (e) => goToSignin(e, false));
}
if (signinBtnMobile) {
